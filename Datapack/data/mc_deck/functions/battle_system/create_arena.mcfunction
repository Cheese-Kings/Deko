...
scoreboard players add @e[sort=nearest,limit=1,type=minecraft:area_effect_cloud,tag=mc_deck.player_zone1] arenaID 0
scoreboard players operation @e[sort=nearest,limit=1,type=minecraft:area_effect_cloud,tag=mc_deck.player_zone1] arenaID += currentMax arenaID
...
setblock ~-3 ~ ~ minecraft:stone_pressure_plate
scoreboard players add @e[sort=nearest,limit=1,type=minecraft:area_effect_cloud,tag=mc_deck.player_zone2] arenaID 0
scoreboard players operation @e[sort=nearest,limit=1,type=minecraft:area_effect_cloud,tag=mc_deck.player_zone2] arenaID += currentMax arenaID