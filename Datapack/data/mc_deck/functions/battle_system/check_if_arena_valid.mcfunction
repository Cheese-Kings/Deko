...
execute if score first_arena_placed Debug matches 1.. run execute unless entity @e[tag=mc_deck.arena_center,distance=..40] run function mc_deck:battle_system/create_arena