...
# Summon center
summon minecraft:area_effect_cloud ~ ~ ~ {Age: -2147483648, Duration: -1, WaitTime: -2147483648, Tags: ["deko.battle.arena.center", "global.ignore", "global.ignore.pos"]}
...
# Summon player zones
summon minecraft:area_effect_cloud ~3 ~ ~ {Age: -2147483648, Duration: -1, WaitTime: -2147483648, Tags: ["deko.battle.arena.player_zone1", "global.ignore", "global.ignore.pos"]}
...
summon minecraft:area_effect_cloud ~-3 ~ ~ {Age: -2147483648, Duration: -1, WaitTime: -2147483648, Tags: ["deko.battle.arena.player_zone2", "global.ignore", "global.ignore.pos"]}
setblock ~-3 ~ ~ minecraft:stone_pressure_plate
